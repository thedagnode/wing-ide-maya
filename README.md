...
1. Click this File Link [wing_installer.py](https://github.com/thedagnode/wing-ide-maya/releases/download/v0.9.3/wing_installer.py) to download the installation python file.
