...
1. Click this File Link [wing_installer.py](https://github.com/thedagnode/wing-ide-maya/blob/main/wing/wing_installer.py) to download the installation python file.
